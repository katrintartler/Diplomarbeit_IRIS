...
\subsection{Layout}
Damit das Layout erstellt werden konnte, mussten zuerst alle Sysmbole Footprints zugewiesen bekommen. Dieser Schritt ist einer der wichtigsten bei der 
...
eine druchgängige GND-Fläche. Auch die Positionierung des ESPs ist mihilfe der Espressif Design Rules erfolgt \cite{esp32_pcb_layout_design}. So wurde darauf 
...
\par\vspace{1em}
\noindent
Bei der Fertigung der Hauptplatine des Testroboters wuden auch ein paar Bauteile mitbestückt,
da die Lieferzeit der einzelnen Komponenten zu lange für eine selbständige Bestückung war. Der Spannungsregler, der MOSFET sowie alle SMD-Bauteile wurden 
...
Auch das DFPlayer-Modul ist nur mittels Siftleisten auf der Platine befestift. 
\par\vspace{1em}
\noindent
Die Spannungsreglerschaltung im Layout wurde auf den LM2596Adj (adjustable) angepasst, sie beeinhaltet das 50k$\Omega$ Potentiomer welches dann einen 
...
So fließt der Strom dann durch die Keramikwiderstände und die Wärme entsteht. Um mehr Sicherheit zu gewährlsiten wurde auf dieser Platine auch eine 
...
bei zuhöhen Temperaturen die Wärmesimulation abschalten kann. 
...
\end{figure}
Das Layout der Heatplatine, siehe Abbildung \ref{fig:pcb:H_layout} muss nicht so vielen Anforderungen entsprechen wie das der Haupplatine. Der wichtigste Askpekt war es die Versorgungsleiterbahnen 
...
Die Sicherheitskomponente PT100, mit dazu gehötigem Teilerwiderstand konnte aufgrund von Lieferverspätung von nicht eingelötet werden. 
...
\par\vspace{1em}
\noindent
Beim Testen eine Diskrepanz zwischen dem Verlauf der Leiterbahnen der gefertigten 
...
Dieser Fehler gestalete sich aber nicht weiter schlimm da er keine Auswirkungen auf die Funktion der Leiterplatte hatte. Es mussten nur die Schraubklemmen neu beschriftet werden.
