...
welche man dann nur mehr auf der Homepage hochladen muss. Bei der Fertigung der Hauptplatine des Testroboters wuden auch ein paar Bauteile mitbestückt. 
...
ersetzt, weil kein passender 1$\mu$F zur Hand war. 
\par\vspace{1em}
\noindent
...
den ESP nicht als Verbindungspartner wahrnehmen. Zur Lösung wurde das Potentiometer mit einem Stück Draht überbrückt, siehe Abbildung \ref{fig:drahtbrücke}. 
...
Die Wärmesimulation mit den Keramikwiderständen, ist aus Sicherheitesgründen auf einer anderen Platine untergebracht, veranschaulicht ist das in Abbildung \ref{fig:pcb:H_all}.
...
So fließt der Strom dann durch die Keramikwiderstände und die Wärme entsteht. 
...
\par\vspace{1em}
Nachdem die Bauteile dem Layout entsprechend eingelötet worden sind, ist uns beim Testen eine Diskrepanz zwischen dem Verlauf der Leiterbahnen der gefertigten 
